...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\LARGE A comparison of a phenomenological model with the Holling mechanistic models of functional responses, focusing on consumer foraging movement\\} % Title
